...
// O tipo é obrigatório no formulário, por isso garantimos que ele existe aqui.
...
export function LocationsPage() {
  ...
  // Debounce da busca: espera 400ms sem digitar antes de chamar a API.
  useEffect(() => {
  ...
  // O mesmo modal serve para criar e editar. O formMode decide qual chamada é feita.
  ...
  // Alterar situação é uma ação menor, por isso usa um modal separado do formulário.
  ...
  async function handleConfirmRemoveLocation() {
    ...
    try {
      ...
      // Se era o último item de uma página além da primeira, voltamos uma página.
  ...
  return (
    <AppLayout currentPage="Localizações">
      <Container>
        ...
        {/* Modal para mudança rápida de situação. */}
        <LocationStatusModal
